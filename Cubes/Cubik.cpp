...
int CubikRubik::find_element(colour temp_colour, elementType temp_type) {
    ...
    for (int i = 0; i < _elements[temp_index].size(); i++) {//если миникуб находится не в константном положении и если одна из сторон совпадает с нужным цветом, то мы нашли нужный куб
